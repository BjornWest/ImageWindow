...
public class Generate {
   ...
   //         System.out.println((yDistance+" "+xDistance));
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(generate.radAng(300)[0]));
        System.out.println(Arrays.toString(generate.radAng(300)[1]));
